...
SCRIPT_MAIN = BASE_DIR / "demo_1.py"

SCRIPT_1 = BASE_DIR /  "script1_dataset_collection_protocol.py"
SCRIPT_2 = BASE_DIR / "script2_analysis_training_export.py"
SCRIPT_3 = BASE_DIR / "script3_live_classification.py"
...
<section>
    <div class="card dark-card">
        ...
        <h2>Resting vs Walking Classification from PPG Noise Features</h2>

        <p>
            PPG signals are useful for wearable health monitoring, but they are
            highly affected by movement. During resting, the cardiac waveform is
            usually clearer. During walking, the signal may become distorted,
            noisy, or difficult to interpret.
        </p>

        <div class="question">
            <h3>Research Question</h3>
            <p>
                Which PPG-derived noise features best separate Resting from Walking,
                and can these features be used for real-time classification?
            </p>
        </div>
        ...
        <div class="workflow">
            <div class="workflow-step">
                ...
                <p>
                    Run a guided protocol: stabilization, resting, pause,
                    and walking. Save one feature row every 10 seconds.
                </p>
                <button class="outline" onclick="launchScript1()">Launch Dataset Collection</button>
            </div>
            ...
            <div class="workflow-step">
                ...
                <p>
                    Load the CSV, compare features with boxplots, select useful
                    feature combinations, train a simple AI model, and export it.
                </p>
                <button class="outline" onclick="launchScript2()">Launch Analysis and Training</button>
            </div>
            ...
            <div class="workflow-step">
                ...
                <p>
                    Load the exported model, stream raw PPG in real time,
                    extract features, and classify Resting vs Walking live.
                </p>
                <button class="outline" onclick="launchScript3()">Launch Live Classification</button>
            </div>
        </div>
    </div>
</section>
