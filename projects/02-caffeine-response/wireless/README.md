# Project 02. Caffeine response, wireless workflow
...
python ../../../tools/ppg_simulator.py --scenario caffeine   # no hardware, in a separate terminal
...
Firmware for this version is under `hardware/wireless-esp32/project-02-*`.
