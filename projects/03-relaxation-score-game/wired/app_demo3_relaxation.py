...
SCRIPT_1 = BASE_DIR / "script1_relaxation_dataset_collection.py"
SCRIPT_2 = BASE_DIR / "script2_relaxation_analysis_training_export.py"
SCRIPT_3 = BASE_DIR / "script3_relaxation_live_score_game.py"
    ...
    <div class="card">
        ...
        <div class="grid">
            ...
            <div class="mini-card">
                <span>02</span>
                <h3>Raw Signal</h3>
                <p>The sensor captures a noisy waveform affected by movement.</p>
            </div>
...
<section>
    <div class="card dark-card">
        <span class="tag">Project 3: Relaxation Game</span>
        <h2>Relaxation vs Non-Relaxation from PPG Features</h2>

        <p>
            In this demo, students collect PPG data before and after a guided
            relaxation protocol. The goal is to compare pre-relaxation and
            post-relaxation physiology using extracted PPG features, then train
            a simple model that converts live PPG behavior into a relaxation score.
        </p>

        <div class="question">
            <h3>Research Question</h3>
            <p>
                Which PPG-derived features change after a relaxation exercise,
                and can these features be used to create a real-time relaxation
                score game?
            </p>
        </div>

        <div class="feature-strip">
            <div class="feature-pill">Stabilizing Baseline</div>
            <div class="feature-pill">Pre-Relaxation Recording</div>
            <div class="feature-pill">Deep Breathing Technique</div>
            <div class="feature-pill">Relaxation State</div>
            <div class="feature-pill">Post-Relaxation Recording</div>
            <div class="feature-pill">Multiple Recordings</div>
        </div>
        ...
        <div class="workflow">
            <div class="workflow-step">
                ...
                <p>
                    Run repeated recordings with a fixed protocol: stabilizing
                    baseline, pre-relaxation, deep breathing, relaxation state,
                    and post-relaxation. Export feature rows to CSV.
                </p>
                <button class="outline" onclick="launchScript1()">Launch Data Collection · Export Data</button>
            </div>
            ...
            <div class="workflow-step">
                ...
                <p>
                    Load the exported CSV, generate one box plot per feature
                    comparing pre-relaxation and post-relaxation, train a model,
                    and export the relaxation scorer.
                </p>
                <button class="outline" onclick="launchScript2()">Load Data and Train Model</button>
            </div>

            <div class="workflow-step">
                <div class="number">3</div>
                <h3>Relaxation Score Game</h3>
                <p>
                    Load the trained model, stream live PPG, extract features,
                    and display a real-time relaxation score based on the
                    training data.
                </p>
                <button class="outline" onclick="launchScript3()">Load Model and Play</button>
            </div>
        </div>
    </div>
</section>
...
if __name__ == "__main__":
    ...
    print("Starting local PPG relaxation demo website...")
    print(f"Open: {url}")
