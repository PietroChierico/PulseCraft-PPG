# Project 03. Relaxation score game, wireless workflow
...
python ../../../tools/ppg_simulator.py --scenario relaxation   # no hardware, in a separate terminal
...
Firmware for this version is under `hardware/wireless-esp32/project-03-*`.
