...
<section>
    <div class="card dark-card">
        ...
        <p>
            In this demo, students collect WiFi IR PPG data before and after a guided
        ...
        <div class="question">
            ...
            <p>
                ...
                and can these IR features be used to create a real-time relaxation
                score game?
            </p>
        </div>
        ...
        <div class="workflow">
            ...
            <div class="workflow-step">
                ...
                <p>
                    Load the trained model, stream live WiFi IR PPG, extract features,
...
if __name__ == "__main__":
    ...
    print("Starting local PPG WiFi IR relaxation demo website...")
    print(f"Open: {url}")
