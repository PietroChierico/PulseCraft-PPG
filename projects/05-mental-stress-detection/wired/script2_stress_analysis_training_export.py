...
Purpose
-------
Load the Arduino serial CSV exported from Script 1, compare each PPG feature between Relaxed
...
class MentalStressTrainingWindow(QMainWindow):
    ...
    def train_model(self) -> None:
        ...
        self.model_bundle = {
            ...
            "input_transport": "Arduino USB serial",
            "window_seconds": 10,
    ...
    def export_model(self) -> None:
        if self.model_bundle is None:
            ...
            return
        default_name = f"ppg_mental_stress_serial_model_{int(time.time())}.joblib"
