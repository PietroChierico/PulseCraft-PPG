...
<section>
    <div class="card dark-card">
        ...
        <p>
            ...
            dynamics using wearable IR PPG sensors. Participants complete relaxed
            baseline periods, mental arithmetic, timed reaction tasks, and cognitive
            interference challenges while physiological signals are recorded.
        </p>
        ...
        <div class="workflow">
            ...
            <div class="workflow-step">
                ...
                <p>
                    Load the trained model, stream live WiFi IR PPG, extract the same
                    features, and display a real-time mental stress score during an
...
if __name__ == "__main__":
    ...
    print("Starting local PPG WiFi IR mental stress demo website...")
    print(f"Open: {url}")
